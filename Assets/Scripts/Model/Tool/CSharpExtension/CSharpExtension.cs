...
namespace Bepop.Core
{
    ...
    public static class IEnumerableExtension
    {
        ...
        ///         .ForEach(keyValue => BepopLog.BASE.I("key:{0},value:{1}", keyValue.Key, keyValue.Value));
        /// </code>
        /// </summary>
        /// <returns>The each.</returns>
        /// <param name="selfArray">Self array.</param>
        ...
        /// dictionary3.ForEach(pair => BepopLog.BASE.I("{0}:{1}", pair.Key, pair.Value));
        /// </code>
        /// </summary>
        ...
        /// dict.ForEach((key,value)=> BepopLog.BASE.I("{0}:{1}",key,value);//  name:liangxie    age:18
        /// </code>
        /// </summary>
    ...
    public static class ProbilityHelper
    {
        ...
        {
            return UnityEngine.Random.Range(0, 1000) * 0.1f < percent;
        }
    }
    /// <summary>
    /// 面向对象扩展（继承、封装、多态)
...
//            BepopLog.BASE.E(">>>>>>>Error: Can\'t find Assembly-CSharp.dll");
            return null;
        }
...
//            BepopLog.BASE.E(">>>>>>>Error: Can\'t find Assembly-CSharp-Editor.dll");
            return null;
        }
    ...
    public static class CameraExtension
    {
        public static void Example()
        {
            ...
            Log.BASE.I(screenshotTexture2D.width);
        }
    ...
    public static class ObjectExtension
    {
        public static void Example()
        {
            ...
            gameObject
                .ApplySelfTo(selfObj => Log.BASE.I(selfObj.name))
                .Name("TestObj")
                .ApplySelfTo(selfObj => Log.BASE.I(selfObj.name))
                .Name("ExtensionExample")
                .DontDestroyOnLoad();
        ...
        public static T GetField<T>(this object instance,string fieldName)
        {
            ...
            {
                Log.BASE.LogWarning($"GetField error ! instance:[{instance.GetType().Name}does not has fieldName:{fieldName}\n" + e.StackTrace);
            }
            return default(T);
        }
        ...
        public static void SetField<T>(this object instance, string fieldName, T fieldValue)
        {
            ...
            {
                Log.EX.LogWarning($"SetField error ! instance:[{instance.GetType().Name} does not has fieldName:{fieldName}\n,{e.StackTrace}");
            }
        }
    }

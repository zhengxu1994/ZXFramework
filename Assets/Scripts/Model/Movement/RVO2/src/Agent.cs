...
namespace RVO
{
    ...
    internal class Agent
    {
        ...
        internal FP maxSpeed_ = 0.0f;
        internal FP neighborDist_ = 0.0f;
        ...
        internal void computeNewVelocity()
        {
            ...
            FP invTimeHorizonObst = 1.0f / timeHorizonObst_;
            ...
            for (int i = 0; i < obstacleNeighbors_.Count; ++i)
            {
                ...
                if (s < 0.0f && distSq1 <= radiusSq)
                {
                    ...
                    {
                        line.point = new TSVector2(0.0f, 0.0f);
                ...
                FP t = obstacle1 == obstacle2 ? 0.5f : ((velocity_ - leftCutOff) * cutOffVector) / RVOMath.absSq(cutOffVector);
                 ...
                 * closest to velocity.
                 */
                FP distSqCutoff = (t < 0.0f || t > 1.0f || obstacle1 == obstacle2) ? FP.PositiveInfinity : RVOMath.absSq(velocity_ - (leftCutOff + t * cutOffVector));
                FP distSqLeft = tLeft < 0.0f ? FP.PositiveInfinity : RVOMath.absSq(velocity_ - (leftCutOff + tLeft * leftLegDirection));
                FP distSqRight = tRight < 0.0f ? FP.PositiveInfinity : RVOMath.absSq(velocity_ - (rightCutOff + tRight * rightLegDirection));
            ...
            FP invTimeHorizon = 1.0f / timeHorizon_;
            ...
            for (int i = 0; i < agentNeighbors_.Count; ++i)
            {
                ...
                TSVector2 relativePosition = other.position_ - position_;
                ...
                else
                {
                    ...
                    FP invTimeStep = 1.0f / Simulator.Instance.timeStep_;
        ...
        internal void insertObstacleNeighbor(Obstacle obstacle, FP rangeSq)
        {
            ...
            FP distSq = RVOMath.distSqPointLineSegment(obstacle.point_, nextObstacle.point_, position_);
